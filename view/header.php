...
<link rel="stylesheet" href="../view/plugins/themify-icons/themify-icons.css">
<link rel="stylesheet" type="text/css" href="../view/plugins/jquery-ui-1.12.1.custom/jquery-ui.css">
...
<link rel="stylesheet" type="text/css" href="../view/styles/categories_styles.css">
<link rel="stylesheet" type="text/css" href="../view/styles/categories_responsive.css">
...
<!-- login reg form -->
<link rel="stylesheet" type="text/css" href="../view/styles/log.css">
</head>
<body>
					...
					<div class="col-md-6 text-right">
						<div class="top_nav_right">
							<ul class="top_nav_menu">
								...
								<li class="currency"><a href="index.php?act=reg"><i class="fa fa-user-plus" ></i>Register</a></li>
								<?php
								// var_dump($_SESSION['name']);
										if(isset($_SESSION['user'])){
											echo '<li class="currency"><a href="index.php?act=userinfo"><i class="" ></i>-'.$_SESSION['user'].'-</a></li>
												<li class="currency"><a href="index.php?act=logout"><i class="fa fa-sign-in" >Logout</i>
												</a></li>
											';
										}else{
											echo '<li class="currency"><a href="index.php?act=log"><i class="fa fa-sign-in" ></i>Sign In</a></li>';
										}
									?>
								<!-- <li class="account">
									<a href="#">
									...
									<ul class="account_selection">
										...
										<li><a href="index.php?act=reg"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</a></li>
...
<?php
									foreach($cat as $cat){
										$link = 'index.php?act=product&id_cat='.$cat['id'];
